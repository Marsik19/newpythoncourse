...
class DBManager:
    ...
    @classmethod
    def saveNewsInDatabase(cls, news):
    ...
    def savePersonalAdInDatabase(cls, personalAd):
        params = (personalAd.type, personalAd.descriptionText, personalAd.daysToExpiration, personalAd.expirationDate,
    ...
    def saveSportNewsInDatabase(cls, sportNews):
        params = (sportNews.type, sportNews.descriptionText, sportNews.titleAd, sportNews.city,
                  sportNews.country, sportNews.kindOfSport, sportNews.team1, sportNews.team2,
...
def __writeTextFromPath():
    filePath = input(
        "Please write filePath or will be used standart path. Press ENTER if you want load data from standart path or enter your own.\n")
...
class AdParsedObject(object):
    def __init__(self, city='', country='', type='', descriptionText='', expirationDate='', kindOfSport='', team1='',
                 team2='', scoreTeam1='', scoreTeam2=''):
        self.city = city
        ...
        for item in myRoot.findall('element'):
            ...
            match type:
                ...
                case "Sport News":
                    ...
                    parsedObject = AdParsedObject(city, country, type, descText, expirationDate, kindOfSport, team1,
                                                  team2, scoreTeam1, scoreTeam2)
